...
entry:
  ...
  call void @php_zval_null(%struct.zval* %tmp_3)
  %tmp_4 = load %struct.zval, %struct.zval* %tmp_3
  ret %struct.zval %tmp_4
}

define i32 @main() {
entry:
  %tmp_5 = alloca %struct.zval
  %tmp_6 = call %struct.zval @say_hello()
  store %struct.zval %tmp_6, %struct.zval* %tmp_5
  ret i32 0
}
